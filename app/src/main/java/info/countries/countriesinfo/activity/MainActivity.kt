...
class MainActivity : AppCompatActivity(), ItemClickListener<Country>, SearchView.OnQueryTextListener {
    ...
    override fun itemClicked(country: Country) {
        ...
        Toast.makeText(this, "${countryDetail.name}", Toast.LENGTH_SHORT).show()

        //startActivity(Intent(this, CountryDetailActivity::class.java).putExtra("countryDetail", countryDetail))
    }
